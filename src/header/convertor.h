...
#define PARAM_UNCHECK_TEMPLATE_DLL PARAM(uncheck#dll)
#define PARAM_UNCHECK_TEMPLATE_EXE PARAM(uncheck#exe)
...
void compile_gnu_v2(const char* compiler, const char* args);
void compile_gnu_v3(const char* line);
